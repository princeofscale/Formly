...
function BodyMap({
  ...
  return (
    <svg
      ...
      style={{
        filter:
          'drop-shadow(0 16px 24px rgba(0,0,0,0.45)) drop-shadow(0 0 14px rgba(255,59,71,0.05))',
      }}
    >
      ...
      <g stroke="rgba(255,255,255,0.11)" strokeWidth="2">
        ...
        />
        <path
          d="M115 61 C129 76 134 105 128 136"
          fill="none"
          stroke="#15151C"
          strokeLinecap="round"
          strokeWidth="18"
      ...
      {side === 'front' ? (
        <>
          <g
            onClick={() => onPick('front_delts')}
            className={segmentClass}
            opacity={opacity('front_delts')}
          >
            <path d="M36 57 C25 60 20 70 19 82 C30 80 39 73 43 62 Z" fill={paint('front_delts')} />
            <path
              d="M112 57 C123 60 128 70 129 82 C118 80 109 73 105 62 Z"
              fill={paint('front_delts')}
            />
          </g>
          <g onClick={() => onPick('chest')} className={segmentClass} opacity={opacity('chest')}>
            ...
            <path
              d="M103 61 C93 55 78 57 76 69 L76 91 C92 92 103 82 105 68 Z"
              fill={paint('chest')}
            />
          </g>
          <g onClick={() => onPick('core')} className={segmentClass} opacity={opacity('core')}>
            ...
            <path
              d="M60 103 L88 103 M58 112 L90 112"
          ...
          <g onClick={() => onPick('biceps')} className={segmentClass} opacity={opacity('biceps')}>
            <path
              d="M18 82 C24 79 31 82 33 91 L29 112 C22 111 17 105 16 96 Z"
              fill={paint('biceps')}
            />
            <path
              d="M130 82 C124 79 117 82 115 91 L119 112 C126 111 131 105 132 96 Z"
              fill={paint('biceps')}
            />
          </g>
          <g
            onClick={() => onPick('forearms')}
            className={segmentClass}
            opacity={opacity('forearms')}
          >
            <path
              d="M27 114 C34 116 37 123 34 136 L27 156 C20 153 17 144 20 134 Z"
              fill={paint('forearms')}
            />
            <path
              d="M121 114 C114 116 111 123 114 136 L121 156 C128 153 131 144 128 134 Z"
              fill={paint('forearms')}
            />
          </g>
        ...
        <>
          <g
            onClick={() => onPick('rear_delts')}
            className={segmentClass}
            opacity={opacity('rear_delts')}
          >
            <path d="M36 57 C25 60 20 70 19 82 C31 80 40 73 43 62 Z" fill={paint('rear_delts')} />
            <path
              d="M112 57 C123 60 128 70 129 82 C117 80 108 73 105 62 Z"
              fill={paint('rear_delts')}
            />
          </g>
          <g onClick={() => onPick('traps')} className={segmentClass} opacity={opacity('traps')}>
            <path
              d="M50 56 C61 48 87 48 98 56 C91 66 82 72 74 72 C66 72 57 66 50 56 Z"
              fill={paint('traps')}
            />
          </g>
          <g onClick={() => onPick('back')} className={segmentClass} opacity={opacity('back')}>
            <path
              d="M48 69 C61 62 87 62 100 69 L96 111 C84 119 64 119 52 111 Z"
              fill={paint('back')}
            />
          </g>
          <g onClick={() => onPick('lats')} className={segmentClass} opacity={opacity('lats')}>
            ...
            <path
              d="M108 73 C100 84 97 102 99 120 C107 117 112 105 113 91 Z"
              fill={paint('lats')}
            />
          </g>
          <g
            onClick={() => onPick('triceps')}
            className={segmentClass}
            opacity={opacity('triceps')}
          >
            <path
              d="M18 82 C24 79 31 82 33 91 L29 112 C22 111 17 105 16 96 Z"
              fill={paint('triceps')}
          ...
          <g onClick={() => onPick('glutes')} className={segmentClass} opacity={opacity('glutes')}>
            <path
              d="M49 126 C58 121 70 124 72 137 C67 146 54 148 46 140 Z"
              fill={paint('glutes')}
            />
            <path
              d="M99 126 C90 121 78 124 76 137 C81 146 94 148 102 140 Z"
              fill={paint('glutes')}
            />
          </g>
          <g
            onClick={() => onPick('hamstrings')}
            className={segmentClass}
            opacity={opacity('hamstrings')}
          >
...
export function MuscleHeatmap({
  ...
  const ranked = useMemo(
    () =>
      MUSCLE_GROUPS.map((muscle) => ({ muscle, sets: volumeFor(muscle, muscleVolumes) })).sort(
        (a, b) => b.sets - a.sets,
      ),
    [muscleVolumes],
  )
            ...
            return (
              <button
                ...
                className={`h-8 rounded-xl px-3 text-xs font-bold transition ${
                  active
                    ? 'bg-primary text-white shadow-[0_8px_20px_rgba(255,59,71,0.22)]'
